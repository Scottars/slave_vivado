...
module udp(
			...
			output wire 	       data_o_valid,                        //接收数据有效信号   ws:这个代码是为给ram的存储程序用，当接收到合适的程序后，就会置位有效，然后实现啊数据的存储
		   ...
		   output wire [9:0]     ram_wr_addr,                         //ram数据写地址
		   ...
		   output wire [9:0]     ram_rd_addr,                         //ram数据读地址
